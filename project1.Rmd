...
ggplot(data=activity, aes(y=activity$MeanSteps, x=activity$interval)) + labs(x="Five Minute Interval", y="Average Steps per Interval")+ geom_line()
...
ggplot(data=projdata_final_gg, aes(projdata_final_gg$TotSteps)) +labs(x="Total Steps per Day", y="Count")+ geom_histogram()
...
xyplot(data=projdata_days_gg, MeanSteps~interval|weekday, type ='l', auto.key = T,layout=c(1,2), xlab="Interval",ylab="Mean Steps per Interval")
```
